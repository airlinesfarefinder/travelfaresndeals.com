        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="hero-content">
                    <div class="welcome-text">Welcome to Your Next Adventure</div>
                    <h1 class="hero-title">Explore the World with Ease</h1>
                    <p class="hero-subtitle">
                        Find the best flight deals, compare routes effortlessly, and enjoy a smooth booking experience—wherever your journey takes you.
                    </p>
            ...
            <div class="col-md-6 " > 
                <div class="hero-image hero-content ">
                    ...
                    <img src="./images/345-removebg-preview.png">
